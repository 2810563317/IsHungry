			...
			<div class="food-content">
				...
				<div class="content">
					...
					<div class="cartcontol-wrapper">
						<cartcontral @getTarget="target" :food="food"></cartcontral>
					</div>
				...
				<div class="rating">
					...
					<ratingselect @ratingselect='selectTypeFC' :desc="desc" :selectType="selectType" :onlyContent="onlyContent" :ratings="food.ratings"></ratingselect>
...
<script type="text/ecmascript-6">
	...
	export default{
		...
		methods: {
			show(){
				//初始化状态
				this.showFlag = true;	 //是否显示详情页面	
				this.selectType= ALL,    //选择全部
				this.onlyContent= true,  //是否只看有内容的评价
				this.$nextTick(() => {
					if(!this.scroll){
